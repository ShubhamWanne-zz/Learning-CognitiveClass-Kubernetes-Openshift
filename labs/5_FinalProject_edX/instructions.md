...
6. It will take a few minutes to provision the Cloudant service instance. Find your Cloudant instance under the **Services** section. Refresh the page a few times. Once the status on your instance is **Active**, click the instance name to go to the details page for the service instance.
...
1. Get the Route to your application.
```
oc get routes
```
{: codeblock}
...
```
while sleep 1; do curl -s http://$HEALTH_ROUTE/info; done
```
{: codeblock}
